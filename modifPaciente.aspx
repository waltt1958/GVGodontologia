<%@ Page Title="" Language="VB" MasterPageFile="~/M.master" AutoEventWireup="false" CodeFile="modifPaciente.aspx.vb" Inherits="modifPaciente" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h3>ACTUALIZACION DATOS DE PACIENTE. No puede cambiar el DNI</h3>
    ...
    <table style="width: 45%;" align="center" border="2" cellspacing="0" bordercolor="black">
        <tr>
            ...
            <td width="30%" align="center">
               <div class="tdCenter" ><asp:TextBox ID="dni" MaxLength="10"  onkeypress="return validaNumericos(event)" runat="server" Enabled="False" style="width: 128px"></asp:TextBox></div>
