<%@ Page Title="" Language="VB" MasterPageFile="~/M.Master" AutoEventWireup="false" CodeFile="buscaHistClinica.aspx.vb" Inherits="buscaHistClinica" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h3>INGRESOS LOS DATOS PARA BUSCAR LA HISTORIA CLINICA</h3>
        ...
        <tr>
           ...
           <asp:Button ID="btVolver" PostBackUrl="~/index.aspx" CausesValidation="false" CssClass="button" runat="server" Text="VOLVER AL INICIO"></asp:Button>
            ...
            <td align="center">
           <asp:Button ID="btVERIFICA" CssClass="button" runat="server" Text="BUSCAR HIST. CLINICA"></asp:Button>
        </td>
        </tr>
       </table>
