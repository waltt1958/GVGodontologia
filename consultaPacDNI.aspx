<%@ Page Title="" Language="VB" MasterPageFile="~/M.Master" AutoEventWireup="false" CodeFile="consultaPacDNI.aspx.vb" Inherits="nombresPac" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:AccessDataSource runat="server" ID="AccessDataSource1" DataFile="~/bbdd/gvg.accdb" SelectCommand="SELECT * FROM [pacientes] WHERE ([dni] = ?) ORDER BY [aYnombre]">
        <SelectParameters>
