        ...
        Select Case radio2.SelectedValue
            ...
            Case "Documento"
                ...
                If oDataReader.Read() = True Then
                    ...
                    oDataReader.Close()
                    con.Close()
                    Response.Write("<script>window.setTimeout(location.href='consultaPacDNI.aspx', 2000);</script>")
            ...
            Case "Apellido"
                ...
                oDataReader.Close()
                con.Close()
                Response.Write("<script>window.setTimeout(location.href='consultaPac.aspx', 2000);</script>")
